...
function Blogs() {
  return (
    <div className=" text-white font-cinzel w-full">
      {/* Blog Heading */}
     <div className="relative  text-white px-2  sm:px-8 md:px-16 lg:px-24  py-8 md:py-16 w-full max-w-screen-xl border-r-4 border-[#CA8304]  mx-auto overflow-hidden">
  {/* Top Border */}
...
<div className="flex justify-center mt-4 md:mt-0 md:block md:absolute md:right-4 sm:md:right-8 md:top-1/2 md:transform md:-translate-y-1/2">
  <button className="bg-[brown] font-cinzel text-lg md:text-2xl text-white font-bold px-6 md:px-8 py-2 rounded-full border-2 border-[#CA8304] hover:bg-[#CA8304] transition duration-300">
    All Blogs
      ...
      {/* Blog Cards */}
      <div className=" text-white px-4 sm:px-8 md:px-12 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 justify-center max-w-screen-xl mx-auto">
          {[...Array(4)].map((_, i) => (
            ...
            >
              <div className=" rounded-t-xl border-4 border-[#CA8304] border-b-0">
                <img
                  src="/blog.jpg"
                  alt="Blog"
              ...
              {/* Info */}
              <div className=" p-5 rounded-xl border-2 border-[#CA8304] mt-1 border-t-1">
                <p className="text-lg text-[#CA8304] font-bold mb-1">CAREER</p>
                <p className="text-sm text-gray-800 mb-2">05 JUL 2025</p>
                <h3 className="text-md text-black font-semibold leading-relaxed">
