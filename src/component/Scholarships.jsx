  ...
  return (
    <div className="w-full flex flex-col items-center relative overflow-hidden px-2 sm:px-4">
      ...
      <div className="flex flex-row items-center justify-center w-full gap-2 sm:gap-1 md:gap-2 mb-6">
        {/* Left Image */}
        <div className="hidden sm:block w-[20%] opacity-50 scale-90 transition-all duration-700 relative">
          <img
        ...
        {/* Center Image */}
        <div className="w-full sm:w-[60%] relative transition-all duration-700">
          <img
...
function HexButton() {
  return (
    <button className="hex-button px-3 py-2 sm:px-4 sm:py-2 text-white bg-[#Ea8306] rounded-md font-semibold text-xs sm:text-sm hover:scale-110 transition-transform duration-300">
      Apply Now
    </button>
  );
}
