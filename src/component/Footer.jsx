...
function Footer() {
    return (
        <div className="w-full bg-black  font-Montserrat font-normal  relative">
            <div className="relative w-[94%] mx-auto h-[550px] p-9 overflow-hidden">
                {/* Background Video */}
                <video
                    autoPlay
                    loop
                ...
                {/* Text content */}
                <div className="relative z-20 text-white grid grid-rows-2 gap-8">
                    {/* Content for c-1 */}
                    <div className="c-1 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 m-auto gap-4 h-full">
                        {/* HQ Office */}
                        <div className="r1">
                            <h1 className="text-xl  text-black">HQ Office</h1>
